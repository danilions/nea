...
export function DigitalLionSection() {
  ...
  return (
    <section className="w-full max-w-2xl mx-auto py-12 px-4 flex flex-col items-center bg-white rounded-lg shadow-md">
      <h2 className="text-3xl font-bold text-center mb-2">{t('digital_lion.title')}</h2>
      <p className="text-lg text-gray-600 text-center mb-6">{t('digital_lion.description')}</p>
      ...
      <div className="w-full mt-8 min-h-[80px] bg-gray-50 rounded p-4 text-gray-500 text-center">
